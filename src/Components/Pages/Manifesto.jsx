...
function Manifesto() {
  ...
  return (
    <div className="page manifesto px-md-4 px-2 pt-5">
          ...
          <nav className="navbar navbar-expand-lg navbar-light">
            <div className="container-fluid px-md-4 px-2">
              ...
              <ul className="nav ml-auto justify-content-between d-lg-flex d-none">
                ...
                <li className="nav-item mr-2">
                  <a href="https://twitter.com/azukizen" className="nav-link active icon text-white">
                    <BsTwitter />
                  </a>
                </li>
                <li className="nav-item mr-2">
                  <a href="https://discord.com/invite/azuki" className="nav-link active icon text-white">
                    <FaGamepad />
                  </a>
                </li>
                <li className="nav-item">
                  <a href="https://opensea.io/collection/azuki" className="nav-link active icon text-white">
          ...
          <div className="py-3 mobNavbar" id="mob">
            <nav className="navbar navbar-expand-lg">
              ...
              <ul className="nav w-100 mx-md-4 mx-2 mt-3 pl-2 d-flex flex-column">
                ...
                <li className="h5 pb-3 d-block mobList mt-2 border-bottom">
                  <Link to="garden" className="text-dark">THE GARDEN</Link>
                </li>
                <li className="h5 pb-3 d-block mobList mt-2  border-bottom">
                  <Link to="update" className="text-dark">UPDATES</Link>
                </li>
                <li className="h5 pb-3 d-block mobList mt-2 border-bottom">
                  <Link to="manifesto" className="text-dark">MANIFESTO</Link>
                </li>
                <li className="h5 pb-3 d-block mobList mt-2 border-bottom">
                  <Link to="mindmap" className="text-dark">MINDMAP</Link>
                </li>
                ...
                <li className="h5 pb-3 d-block mobList mt-2 border-bottom">
                  <a href="https://twitter.com/azukizen"
                ...
                <li className="h5 pb-3 d-block mobList mt-2 border-bottom">
                  <a href="https://discord.com/invite/azuki"
                    className="d-flex justify-content-between align-items-center text-dark"
                    style={{ cursor: "pointer" }}
                  >
                    DISCORD{" "}
                ...
                <li className="h5 d-block mobList mt-2">
                  <a href="https://opensea.io/collection/azuki"
                    className="d-flex justify-content-between align-items-center text-dark"
                    style={{ cursor: "pointer" }}
                  >
                    OPENSEA{" "}
      ...
      <div className="container-fluid pl-4" style={{height:"auto"}}>
