        ...
        <nav className="navbar navbar-expand-lg navbar-light">
          <div className="container-fluid px-md-4 px-2">
            ...
            <ul className="nav ml-auto justify-content-between d-lg-flex d-none">
              ...
              <li className="nav-item mr-2">
                <a href="https://twitter.com/azukizen" className="nav-link active icon">
                  <BsTwitter />
                </a>
              </li>
              <li className="nav-item mr-2">
                <a href="https://discord.com/invite/azuki" className="nav-link active icon">
                  <FaGamepad />
                </a>
              </li>
              <li className="nav-item">
                <a href="https://opensea.io/collection/azuki" className="nav-link active icon">
